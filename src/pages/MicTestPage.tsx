    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-4 space-y-6">
      ...
      <div className="bg-gray-800 p-6 rounded-xl w-full max-w-2xl space-y-4">
        <div className="space-y-2">
          <div>
            <p className="text-lg"><strong className="text-blue-300">Transcript:</strong> {translation ? output.split('\n\nTranslation:')[0].replace('Transcript: ', '') : "No transcript yet..."}</p>
          </div>
          <div>
            <p className="text-lg"><strong className="text-green-300">Translation:</strong> {translation || "No translation yet..."}</p>
          </div>
        </div>
        
        {output && (
          <div className="mt-4 pt-4 border-t border-gray-600">
            <h4 className="text-sm font-bold text-gray-400 mb-2">Full Output:</h4>
